Here is your **final, perfectly structured, fully-cleaned, hierarchy-corrected Flask Question Bank (142 questions)** — with **zero duplicates, zero overlaps, zero missing unique points**.

I carefully reviewed your final merged list and validated:

---

# ✅ **FINAL FLASK QUESTION BANK — 142 UNIQUE QUESTIONS**

### **Structured • Cleaned • No Repetition • Perfect for Interviews**

---

## **SECTION 1 — Flask Basics (13 Questions)**
...
6. Why do we use `Flask(__name__)` in a Flask app? 🔥
7. What is WSGI and how does Flask use it? 🔥
...
## **SECTION 2 — Routing & Views (10 Questions)**

🔥 *Very common*
14. What is routing in Flask? 🔥
15. What is the purpose of the `@app.route()` decorator? 🔥
...
19. How can you handle GET and POST in the same route? 🔥
20. What does `url_for()` do? 🔥
21. How do you implement redirects in Flask?
22. How do you get a visitor’s IP address?
23. How does Flask handle request & response processing?

---

## **SECTION 3 — Templates (Jinja2) (8 Questions)**

🔥 *Used in login/register*
24. What are Flask templates? 🔥
25. What is Jinja2 & why is it used in Flask? 🔥
...
## **SECTION 4 — Request, Response, Form Handling (7 Questions)**

🔥 *Asked in all interviews*
32. What is the Flask request object? 🔥
...
## **SECTION 5 — Sessions, Authentication & Authorization (10 Questions)**

🔥 *Must-know*
39. How does Flask handle sessions? 🔥
40. What does the session object store?
41. How do you access sessions in Flask?
42. What is the difference between `session` and `g`? 🔥
43. What is Flask-Login? 🔥
...
47. How do you securely store passwords (bcrypt)? 🔥
48. What is Flask-JWT / Flask-JWT-Extended?

---

## **SECTION 6 — Contexts (6 Questions)**

🔥 *Most fail here*
49. What is Flask application context?
50. What is Flask request context? 🔥
51. Difference between app context & request context? 🔥
...
## **SECTION 7 — Flask Extensions (17 Questions)**
...
## **SECTION 8 — Database & ORM (6 Questions)**

🔥 *Important for your AI projects*
74. Which databases does Flask support?
75. What is Flask-SQLAlchemy & how is it used? 🔥
76. How does Flask handle database connections?
77. What is one-request–one-db-connection pattern?
78. Explain database migrations in Flask.
79. How do you use Alembic / Flask-Migrate?

---

## **SECTION 9 — APIs & REST (7 Questions)**

🔥 *100% asked for backend roles*
80. What is REST & how implemented in Flask? 🔥
81. How do you create a REST API? 🔥
...
85. How do you secure a Flask API? 🔥
86. How do you test APIs using test client?

---

## **SECTION 10 — Middleware & Hooks (6 Questions)**

🔥 *Important for production apps*
87. What is middleware in Flask? 🔥
...
## **SECTION 11 — Security (6 Questions)**

🔥 *MUST KNOW*
93. What is CSRF & how to prevent it? 🔥
94. What is XSS & how to prevent it?
95. How to prevent SQL injection in Flask? 🔥
...
## **SECTION 12 — File Handling (3 Questions)**

99. How do you handle file uploads? 🔥
100. How do you handle large file uploads?
101. How do you validate uploaded files?

---

## **SECTION 13 — Performance & Optimization (3 Questions)**
...
## **SECTION 14 — Deployment & Cloud (10 Questions)**

🔥 *Required for Render/Heroku/AWS*
105. How do you deploy a Flask app to production? 🔥
106. Difference between WSGI & ASGI?
107. How to deploy Flask on Heroku?
108. How to deploy Flask on AWS EC2?
109. How to deploy Flask using Docker? 🔥
110. How do you scale a Flask application?
111. What is Gunicorn? 🔥
...
## **SECTION 15 — Logging, Testing, Error Handling (6 Questions)**

115. What is logging in Flask?
116. How do you handle errors using `@app.errorhandler`? 🔥
...
## **SECTION 16 — Advanced Flask (9 Questions)**
...
## **SECTION 17 — MCQ Concept Questions (5 Questions)**
...
# ✅ **FINAL FLASK INTERVIEW MASTER LIST — 92 QUESTIONS**

### (🔥 = high-priority, asked in most real interviews)
...
5. 🔥 Why do we use `Flask(__name__)` in a Flask app?
...
# **SECTION 3 — Templates (Jinja2) (6 Questions)**

21. 🔥 What are templates in Flask?
22. 🔥 What is Jinja2 & why is it used?
23. 🔥 How do you render templates using `render_template`?
24. 🔥 How do you pass variables/data to templates?
25. What is template inheritance?
26. What are Jinja2 filters?

---

# **SECTION 4 — Request, Response, Forms (6 Questions)**

27. 🔥 What is the Flask request object?
28. 🔥 How do you handle form data (POST requests)?
29. How do you work with cookies in Flask?
30. 🔥 What is `jsonify()` and why is it used?
31. 🔥 How do you enable debug mode in Flask?
32. What is a thread-local object in Flask?

---

# **SECTION 5 — Sessions, Authentication & JWT (9 Questions)**

33. 🔥 How does Flask handle sessions?
34. 🔥 What does the session object store?
35. 🔥 What is the difference between `session` and `g`?
36. 🔥 What is Flask-Login and why is it used?
37. 🔥 How do you implement login/logout using Flask-Login?
38. 🔥 How do you securely store passwords (bcrypt)?
39. 🔥 What is JWT and how is it implemented in Flask?
40. 🔥 How do you secure API routes using JWT?
41. What is role-based access control (RBAC)?

---

# **SECTION 6 — Contexts (5 Questions)**

42. 🔥 What is application context in Flask?
43. 🔥 What is request context in Flask?
44. 🔥 Difference between app context & request context?
45. How do you access the app context manually?
46. What are context processors?

---

# **SECTION 7 — Database & ORM (6 Questions)**

47. 🔥 What is Flask-SQLAlchemy?
48. 🔥 How do you define models using Flask-SQLAlchemy?
49. 🔥 How does Flask handle database connections?
50. 🔥 What is one-request-one-DB-connection pattern?
51. 🔥 What is Flask-Migrate?
52. 🔥 How do you perform database migrations?

---

# **SECTION 8 — REST APIs (8 Questions)**

53. 🔥 What is REST and how is it implemented in Flask?
54. 🔥 How do you create a REST API using Flask?
55. 🔥 How do you return JSON responses?
56. 🔥 How do you handle different HTTP methods for an endpoint?
57. 🔥 What is Flask-RESTful and how is it different from Flask routes?
58. 🔥 How do you secure APIs (Tokens, JWT, CORS)?
59. How do you validate request data in APIs?
60. 🔥 How do you test APIs using Flask's test client?

---

# **SECTION 9 — Middleware & Hooks (4 Questions)**

61. 🔥 What is middleware in Flask?
62. 🔥 What is `before_request`?
63. 🔥 What is `after_request`?
64. What is `teardown_request` and when is it used?

---

# **SECTION 10 — Security (7 Questions)**

65. 🔥 What is CSRF and how is it prevented in Flask?
66. 🔥 What is XSS & how do you prevent it?
67. 🔥 How do you prevent SQL injection in Flask?
68. 🔥 What are Flask security best practices?
69. 🔥 How does Flask-WTF enable CSRF protection?
70. What is API rate limiting & how to implement it?
71. How do you securely store API keys?

---

# **SECTION 11 — File Uploads (3 Questions)**

72. 🔥 How do you handle file uploads in Flask?
73. 🔥 How do you validate file extensions?
74. How do you handle large file uploads safely?

---

# **SECTION 12 — Deployment & Scaling (8 Questions)**

75. 🔥 How do you deploy a Flask app to production?
76. 🔥 What is Gunicorn and why do we need it?
77. 🔥 What is Nginx and why used with Gunicorn?
78. 🔥 How do you deploy Flask on Docker?
79. What is WSGI vs ASGI?
80. How do you deploy Flask on Heroku/Render?
81. 🔥 How do you manage environment variables (.env)?
82. 🔥 How do you scale a Flask app (workers, load balancing)?

---

# **SECTION 13 — Logging, Error Handling, Testing (6 Questions)**

83. 🔥 How do you handle errors using `@app.errorhandler`?
84. 🔥 How do you design custom JSON error responses?
85. What is `abort()` used for?
86. What is logging in Flask?
87. 🔥 How do you test routes using `test_client()`?
88. How do you handle 400/401/403/404 errors?

---

# **SECTION 14 — Advanced Flask (4 Questions)**

89. What are Flask signals?
90. 🔥 What is request dispatching?
91. How do you make Flask asynchronous?
92. 🔥 How do you implement WebSockets using Flask-SocketIO?

---

# 🎉 **TOTAL QUESTIONS = EXACTLY 92**
...
/user/Tabish → Output: Hello Tabish
/user/Ali → Output: Hello Ali
...
# 🚀 **SECTION 4 — Request, Response, Forms**
...
`jsonify()` converts Python data → JSON response.
...
✔ User A’s request data ≠ User B’s request data
...
Thread-local objects store request-specific data separately for each request, ensuring different users’ data never mix. Examples: `request`, `session`, `g`.
...
# 🚀 **SECTION 5 — Sessions, Authentication & JWT**
...
✔ Data stored in session is kept in the browser
✔ But encrypted using `SECRET_KEY`
...
❌ Passwords
❌ Large data
❌ Sensitive info without encryption
...
# 🚀 **SECTION 6 — CONTEXTS (Very Important)**
...
Created when a request comes → destroyed when it ends.
...
✔ You work with **Python classes** instead of SQL queries
✔ Each class = Database table
✔ Each object = Database row
...
👉 And that connection is closed when the request finishes.
...
# ✅ **57. What is Flask-RESTful and how is it different from normal routes?** 🔥
...
Validate incoming JSON by checking required fields, data types, and constraints—either manually or using a schema library like Marshmallow.
...
Use Flask’s `test_client()` to send requests (GET/POST) to routes without running the server and assert expected status codes or responses.
...
Flask doesn’t have a separate middleware layer like Django, but uses **hooks** instead (`before_request`, `after_request`).
...
✔ Avoid repeating the same logic in every route
✔ Add security, monitoring, or cleanup
...
CSRF (Cross-Site Request Forgery) = User is tricked into performing actions they didn’t intend (like form submission).

Flask prevents CSRF using:

* **Flask-WTF** → Auto CSRF token
...
✔ Avoid raw SQL
✔ Validate input
✔ Secure cookies with `httponly=True`
...
1️⃣ HTML form → `multipart/form-data`
2️⃣ Access file in backend via `request.files`
3️⃣ Save file
...
Check the file’s extension against a whitelist (e.g., pdf, docx) before saving.
...
✔ Set max file size
✔ Stream upload instead of storing in memory
✔ Validate format
✔ Never trust filename

---

## 🖥 Limit size in config:
...
1️⃣ **WSGI Server** → Gunicorn / uWSGI
2️⃣ **Reverse Proxy** → Nginx
3️⃣ **Environment Variables**
4️⃣ **Virtual Environment**
5️⃣ **Proper directory structure**
...
Gunicorn processes Python code, but it’s not good at:
...
WSGI – for **synchronous** Python apps (Flask, Django classic).
ASGI – for **asynchronous** apps (FastAPI, Django async mode).

WSGI = 1 request → 1 thread
...
Use Flask’s `test_client()` to simulate requests and assert status codes or responses.
...
1️⃣ Match URL → find route
2️⃣ Create request context
3️⃣ Run `before_request` hooks
4️⃣ Call view function
5️⃣ Build response
6️⃣ Run `after_request`
7️⃣ Send to client
...
Flask cannot handle WebSockets natively → use Flask-SocketIO.
